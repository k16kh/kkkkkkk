...
<html>
 ...
 <li class="has-dropdown">
										<a href="#">FeedBack</a>
										<ul class="dropdown">
											<li><a href="viewsClient/avis.php" >Avis</a></li>
											<li><a href="viewsClient/reclamation.php">Reclamations</a></li>
											<li><a href="viewsClient/suggestionP.php">Nos Services</a></li>
											<li><a href="viewsClient/suggestion.php">Suggestions</a></li>
							...
							<div class="col-sm-5">
								<ul class="fh5co-social-icons">
									...
									<li><a href="inscription.php"><i class="icon-login"></i></a></li>
									<li>
					...
					<div class="col-md-3">
						...
						<div class="side animate-box">
                            ...
                            <form method="POST" action="ViewsClient/ajoutReclamtion.php">
                                <h3>Donnez votre ID</h3>
                                <input type="number" name="idUtilisateurr" />
                                <br><br>
                                 <h3>Donnez votre Sujet</h3>
