...
$listesuggestionPClient=$suggestionPC1->afficherSuggestionPsClient();
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="modifierSuggestionP.php?num=<?PHP echo $row['num']; ?>" class="btn btn-primary">Modifier votre suggestion </a>
