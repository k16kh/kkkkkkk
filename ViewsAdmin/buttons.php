...
<div>
    <label class="control-label">Lebelle</label></br>
      <input class=" form-control" style="width: 40%" type="text" name="lib_prod">
</div>
<br>
...
foreach($listeProduits as $row){
  ?>
        <option></option>
        <option value="<?php echo $row['id_cat']; ?>"><?php echo $row['leb_cat']; ?></option>
<?php } ?>
      </select>
</div>
...
<div>
    ...
    <input class=" form-control" style="width: 40%" type="number" name="prix">
</div>
<br>
<div>
    <label class="control-label">Quantite</label></br>
    <input class=" form-control" style="width: 40%" type="number" name="qte_prod">
</div>
<br>
<div>
    <label class="control-label">Image</label></br>
    <input class=" form-control" style="width: 40%" type="text" name="image">
</div>
<br>
<div>
    <label class="control-label">Description</label></br>
      <input class=" form-control" style="width: 40%" type="text" name="description">
</div>
<br>
<div>
