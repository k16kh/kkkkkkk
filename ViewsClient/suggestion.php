...
$listesuggestion=$suggestionP1->afficherSuggestions();
$listesuggestionClient=$suggestionP1->afficherSuggestionsClient();

//var_dump($listeEmployes->fetchAll());
?>	
                  <?PHP
foreach($listesuggestionClient as $row1){
	?>
	...
	<input type="hidden" value="<?PHP echo $row1['numSuggestion']; ?>" name="numSuggestion">
    <a href="modifierSuggestion.php?numSuggestion=<?PHP echo $row1['numSuggestion']; ?>" class="btn btn-primary">Modifier vos retour</a>
	</form>
...
<div class="row">
    <?PHP
foreach($listesuggestion as $row){
	?>
