...
<tr>
<td>sujet</td>
<td><input type="text" name="sujet" value="<?PHP echo $sujet ?>" required pattern="[A-Za-z].{4,}" x-moz-errormessage="sujet dois etre alphabetique"></td>
</tr>
<tr>
<td>commentaire</td>
<td><input type="text" name="commentaire" value="<?PHP echo $commentaire ?>" required pattern="[A-Za-z].{4,}" x-moz-errormessage="commentaire dois etre alphabetique"></td>
</tr>
...
if (isset($_POST['modifier'])){
	$suggestionP=new suggestionP($_POST['num'],$_POST['idUtilisateur'],$_POST['date'],$_POST['sujet'],$_POST['commentaire']);
