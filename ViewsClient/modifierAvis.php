...
<tr>
<td>Sujet</td>
<td><input type="text" name="sujet" value="<?PHP echo $sujet ?>" required pattern="[A-Za-z].{4,}" x-moz-errormessage="la sujet dois etre alphabetique"></td>
</tr>
<tr>
<td>commentaire</td>
...
if (isset($_POST['modifier'])){
	$avis=new avis($_POST['num'],$_POST['id_user'],$_POST['jour'],$_POST['sujet'],$_POST['commentaire'],$_POST['rating']);
